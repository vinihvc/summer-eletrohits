...
const SongsContextMenu = dynamic(() => import('./songs.context-menu'))

const SongsDropdown = dynamic(() => import('./songs.dropdown'))
      ...
      {songs?.map((song, index) => {
        ...
        return (
          <SongsContextMenu key={song.id} data={song}>
            <div className="transition even:bg-background/10 odd:bg-background/30 hover:bg-foreground/5">
              <div
                className={cn(
